  ...
  return (
    <Section id="resume" className="bg-white dark:bg-slate-950">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="relative ml-4 space-y-12 border-l-2 border-slate-200 dark:border-slate-800 md:ml-6">
          {experienceData.map((item, index) => (
            ...
            >
              ...
              <div className="flex flex-col mb-2 sm:flex-row sm:items-center sm:justify-between">
                ...
                <span className="px-3 py-1 mt-2 text-sm font-medium rounded-full text-slate-500 dark:text-slate-400 bg-slate-100 dark:bg-slate-900 w-fit sm:mt-0">
                  {item.period}
                </span>
              </div>

              <div className="mb-3 text-base font-medium text-emerald-500 dark:text-blue-400">
                {item.company}
              </div>
              ...
              {item.achievements && (
                <ul className="ml-4 space-y-1 list-disc list-outside text-slate-600 dark:text-slate-400">
